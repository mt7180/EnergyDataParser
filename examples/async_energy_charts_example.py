...
async def fetch(
    ...
    data = await parser.async_query_API(endpoint.value, params=params)
...
async def main():
    ...
    async with aiohttp.ClientSession() as session:
        tasks = [async_fetch_generation(session, parser.get_country(country), start_date, end_date) for country in countries]
